...
export REACHY_DIALOGUE_AUTO_VOICE_SERVICE_TIMEOUT_SECONDS=120
export REACHY_DIALOGUE_AUTO_VOICE_PLAYBACK_WAIT_GRACE_SECONDS=0.1
export REACHY_DIALOGUE_AUTO_VOICE_PLAYBACK_WAIT_MAX_SECONDS=0
